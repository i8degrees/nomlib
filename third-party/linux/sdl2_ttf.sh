...
FREETYPE_PREFIX=/mnt/fs1/Projects/nomlib.git.bck/third-party/linux/freetype2
export FREETYPE_PREFIX
SDL_PREFIX=/mnt/fs1/Projects/nomlib.git.bck/third-party/linux/sdl2
export SDL_PREFIX

SRC_PREFIX_DIR=/mnt/fs1/Projects/nomlib.git.bck/vendor
