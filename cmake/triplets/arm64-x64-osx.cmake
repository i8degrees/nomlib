...
if(PORT STREQUAL "liblzma")
  ...
  # so both the x86_64 and arm64 slices can compile successfully from a
  # single CMake config.
  list(APPEND VCPKG_CMAKE_CONFIGURE_OPTIONS "-DENABLE_ASSEMBLER=OFF")
...
if(PORT STREQUAL "libjpeg-turbo")
  ...
  list(APPEND VCPKG_CMAKE_CONFIGURE_OPTIONS "-DWITH_SIMD=0" "-DCMAKE_C_FLAGS=--target=arm64-apple-macos" "-DCMAKE_OSX_ARCHITECTURES=arm64")
