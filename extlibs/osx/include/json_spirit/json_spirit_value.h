...
#include "json_spirit_config.h" // auto-generated by CMake

// ENABLE_VALUE, ENABLE_WVALUE, ENABLE_MVALUE and ENABLE_WMVALUE are defined as
// CMake option variables and so you may enable or disable support for these
// by passing the appropiate -D flag to cmake at build time.
//
// comment out the value types you don't need to reduce build times and intermediate file sizes
#if defined (ENABLE_VALUE)
...
#if defined (ENABLE_MAP)
    #define JSON_SPIRIT_MVALUE_ENABLED
#endif

#if defined (ENABLE_UMAP)
